...
var getFederationAddress = function(){    
    ...
    let bridgeContract = web3Client.eth.contract(JSON.parse(bridgeAbi)).at(bridgeAddress);
    return bridgeContract.getFederationAddress();
}
